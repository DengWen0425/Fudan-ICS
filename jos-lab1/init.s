...
.LFE1:
	...
	.stabs	"ntest:(0,26)=ar(2,4);0;255;(0,2)",128,0,0,16
...
.LC10:
	...
	.stabs	"file:P(0,27)=*(0,2)",64,0,0,5
	.stabs	"line:P(0,1)",64,0,0,4
	.stabs	"fmt:P(0,27)",64,0,0,3
	.globl	_panic
